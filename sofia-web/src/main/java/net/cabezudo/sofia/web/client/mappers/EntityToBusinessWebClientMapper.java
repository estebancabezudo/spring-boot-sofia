...
public class EntityToBusinessWebClientMapper {
  public WebClient map(WebClientEntity c) {
    if (c == null) {
      return null;
    }
    int id = c.getId();
    ...
    Language language = c.getLanguage() == null ? null : new Language(c.getLanguage());
